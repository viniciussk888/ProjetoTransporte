...
const Item = ({ title }) => (
  ...
  <View style={styles.item}>
    ...
    <Text style={styles.cardInfoText}><MaterialCommunityIcons name="truck-delivery" size={24} color='#fff' />{" "}Milho</Text>
    <Text style={styles.cardInfoText}><AntDesign name="solution1" size={24} color='#fff' />{" "}BUNGE ALIMENTOS LTDA</Text>
    </View>

    <View style={styles.cardInfo}>
    <Text style={styles.cardInfoText}><MaterialIcons name="attach-money" size={24} color='#fff' />{" "}130,00 p/t</Text>
    <RectButton><Text style={styles.cardInfoTextDetail}>VER DETALHES</Text></RectButton>
    </View>
